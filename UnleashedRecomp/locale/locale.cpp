...
std::unordered_map<std::string, std::unordered_map<ELanguage, std::string>> g_locale =
{
    ...
    },
    {
        ...
        "Options_Desc_NotAvailable",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Diese Option ist an diesem Ort nicht verfügbar." },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
            { ELanguage::Italian,  "" }
        }
    ...
    },
    {
        ...
        "Options_Desc_NotAvailableHardware",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Diese Option ist mit deiner momentanen Hardwarekonfiguration nicht verfügbar." }
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
            { ELanguage::Italian,  "" }
        }
    ...
    },
    {
        ...
        "Options_Desc_OSNotSupported",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Diese Option wird von deinem Betriebssystem nicht unterstützt." },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
            { ELanguage::Italian,  "" }
        }
    ...
    },
    {
        "Installer_Page_SelectLanguage",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Bitte wähle eine Sprache." },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
    ...
    },
    {
        "Installer_Page_Introduction",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Willkommen zu \nUnleashed Recompiled!\n\nDu brauchst eine Xbox 360 Kopie\nvon Sonic Unleashed um mit der Installation fortfahren zu können." },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
    ...
    },
    {
        "Installer_Page_SelectDLC",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Füge die Quellen für die Erweiterungen hinzu." },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
            { ELanguage::Italian,  "" }
        }
    ...
    },
    {
        "Installer_Button_Retry",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "ERNEUT AUSFÜHREN" },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
            { ELanguage::Italian,  "" }
        }
    ...
    },
    {
        ...
        "Installer_Message_InvalidFilesList",
        {
            ...
            { ELanguage::Japanese, "" },
			{ ELanguage::German,   "Die folgenden Dateien sind unzulässig: " },
            { ELanguage::French,   "" },
            { ELanguage::Spanish,  "" },
